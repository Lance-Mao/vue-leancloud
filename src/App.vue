<template>
  <div id="app" class="m-index">
    <div class="nav">
      ...
      <router-link to="/login_phone"><el-button type="danger">手机登录</el-button></router-link>
      <router-link to="/file_upload"><el-button type="danger">文件上传</el-button></router-link> -->
    </div>
